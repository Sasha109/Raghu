          ...
          >
            ...
            >
              <p className="text-lg sm:text-xl text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                Seasoned product and program leader with 14+ years of experience driving strategy, business growth, and large-scale product delivery across OTT, Payments, Telco, E-commerce, and Graphics. Currently VP &amp; Head of Product at <span className="font-semibold text-blue-600 dark:text-blue-400">SonyLIV</span>, leading a 20+ member cross-functional team and managing a $150M+ portfolio. Known for customer-first innovation, operational excellence, and building global products for 350M+ users. Previously led high-impact programs at Amazon Payments and NVIDIA, delivering multi-market, partner-driven solutions. Strong foundation in Six Sigma, ISO, TBEM, and end-to-end SDLC management. B.Tech from COEP with executive PM credentials from IIM Kozhikode.
              </p>
            ...
            >
              ...
              <a
                href="http://in.linkedin.com/in/raghunandanbayes"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 hover:text-blue-600 dark:hover:text-blue-400 transition-colors group"
                aria-label="Visit Raghu's LinkedIn profile"
              >
                <div className="w-10 h-10 bg-blue-100 dark:bg-blue-900/50 rounded-full flex items-center justify-center group-hover:bg-blue-200 dark:group-hover:bg-blue-800/50 transition-colors backdrop-blur-sm">
                  <svg
                    className="w-5 h-5 text-blue-600 dark:text-blue-400"
